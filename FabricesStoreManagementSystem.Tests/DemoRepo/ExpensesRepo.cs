...
public class ExpensesRepo
{
    ...
    {
        new Expense { Id = Guid.Parse("a192dbc3-51ae-4725-a752-b08a9b38005b"), Message = "test 1", SyrianAmount = 1000, DollarPriceInSyr = 118.2m, CreatedAt = DateTime.UtcNow.AddDays(-2)},
