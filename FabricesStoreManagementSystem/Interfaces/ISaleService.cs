...
public interface ISaleService
{
    ...
    Task<Result<PaginatedList<SaleResponse>>> GetSales(PaginationRequest paginationRequest, SortRequest sortRequest, DateRangeRequest? dateRangeRequest, SearchRequest? searchRequest, CancellationToken cancellationToken = default);
