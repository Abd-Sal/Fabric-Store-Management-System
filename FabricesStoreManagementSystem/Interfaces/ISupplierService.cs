...
public interface ISupplierService
{
    ...
    Task<Result<PaginatedList<PurchaseResponse>>> GetPurchasesBySupplier(Guid id, PaginationRequest paginationRequest, SortRequest sortRequest, CancellationToken cancellationToken = default);
}
