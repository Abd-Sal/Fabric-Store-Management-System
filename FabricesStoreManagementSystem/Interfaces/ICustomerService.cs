...
public interface ICustomerService
{
    ...
    Task<Result<PaginatedList<SaleResponse>>> GetSaleByCustomer(Guid id, PaginationRequest paginationRequest, SortRequest sortRequest, CancellationToken cancellationToken = default);
}
